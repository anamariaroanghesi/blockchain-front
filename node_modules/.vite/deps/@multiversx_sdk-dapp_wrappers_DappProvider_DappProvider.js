...
import {
  p as p5
} from "./chunk-LM54QQ2E.js";
import "./chunk-32QY5LA4.js";
import {
  faRefresh
} from "./chunk-ZKMUWI2U.js";
import "./chunk-O6DQS572.js";
...
import {
  u as u5
} from "./chunk-KOEJFFA4.js";
import {
  S as S4,
  h
} from "./chunk-4VGTFJ6S.js";
...
import {
  y as y3
} from "./chunk-DJCFANOO.js";
import {
  T as T3
} from "./chunk-775JZQPL.js";
import {
  q as q2
} from "./chunk-ZK7RQOWO.js";
...
var b3 = ({ errorMessage: s2, sessionId: i6, transactions: c2, clearSignInfo: t3 }) => {
  console.error("Unable to send transactions", s2), a2.dispatch(X({ sessionId: i6, status: "fail", errorMessage: s2, transactions: c2.map((d5) => xt(yt({}, d5), { status: "not executed" })) })), t3 == null || t3();
};
...
var b4 = ({ errorMessage: t3, sessionId: n5, clearSignInfo: s2 }) => {
  console.error("Unable to send transactions", t3), a2.dispatch(X({ sessionId: n5, status: "fail", errorMessage: t3 })), s2 == null || s2();
};
...
var b5 = (A7) => Bt(void 0, [A7], function* ({ session: o, sessionId: s2, clearSignInfo: c2, sendSignedBatchTransactionsAsync: d5 }) {
  ...
  return t3 && a2.dispatch(S(t3)), T3({ transactions: t3 == null ? void 0 : t3.transactions }).map((r3) => r3.hash);
});
var Q2 = (g7) => Bt(void 0, [g7], function* ({ session: o, sessionId: s2, clearSignInfo: c2, sendSignedBatchTransactionsAsync: d5 = q2, sendSignedTransactionsAsync: A7 = y3 }) {
  ...
  if (!e2)
    return;
  if ((n5 = o.customTransactionInformation) == null ? void 0 : n5.grouping)
    try {
...
var mn = ({ sendSignedTransactionsAsync: i6 = y3, sendSignedBatchTransactionsAsync: s2 = q2 }) => {
  let a5 = d(), { nonce: m5 } = k(n2), e2 = k(f5), o = (0, import_react.useRef)(false), S6 = (0, import_react.useRef)([]), f6 = () => {
    ...
    for (let t3 of D3) {
      ...
      if (S6.current.includes(t3))
        continue;
      let { transactions: r3 } = n5;
      if (!r3 || !(n5.status === "signed" && !o.current))
        continue;
...
var S5 = false;
function Lt() {
  let s2 = k(r), Pe = k(m2), D3 = k(m), { loginMethod: v2, iframeLoginType: Ie } = k(t2), Ce = k(u4), u8 = k(A), N3 = k(C), b6 = k(f4), E3 = k(I2), ye = k(x2), o = k(C2), T4 = o == null ? void 0 : o.nativeAuthConfig, Le = Y2(T4 || false), { data: m5, isLoading: W2, error: _3 } = A3(u8), A7 = (0, import_react8.useRef)(false), t3 = d(), { setLedgerProvider: Se, ledgerData: p7 } = F();
  a4();
  ...
  function We() {
    return Bt(this, null, function* () {
      let { remainingParams: { impersonate: r3, multisig: e2 } } = y2(["impersonate"]), i6 = H(u8);
      if (!(o != null && o.nativeAuthToken) || r3 || e2 || i6)
        return;
    ...
    return Bt(this, null, function* () {
      ...
      if (n3(r3), Ce != null) {
        try {
          ...
          if (!e2)
            return n3(V2), t3(b(null)), t3(M2(null)), i6();
          let w3 = yield A4({ loginToken: o == null ? void 0 : o.loginToken, extraInfoData: { multisig: Oe, impersonate: je }, address: e2, signature: l5, loginService: Le });
          w3 && (A7.current = true, t3(J(true)), t3(f({ address: w3.address, loginMethod: "wallet" })), t3(O2(xt(yt({}, w3), { nonce: A2(w3) }))), t3(J(false))), i6();
        } catch (e2) {
  ...
  function He() {
    return Bt(this, null, function* () {
      let r3 = yield M3();
      if (!s2.metamaskSnapWalletAddress)
...
var x5 = () => {
  ...
  V({ data: i6 }), (o = e2.init) == null || o.call(e2), m3(e2);
};
var O4 = ({ children: e2, customNetworkConfig: i6 = {}, externalProvider: o, environment: m5, customComponents: C5, dappConfig: t3 }) => {
  ...
  return o != null ? m3(o) : t3 != null && t3.shouldUseWebViewProvider && x5(), import_react10.default.createElement(Provider_default, { context: t, store: a2 }, import_react10.default.createElement(PersistGate, { persistor: z2, loading: null }, () => import_react10.default.createElement(ae, { environment: m5, customNetworkConfig: i6, dappConfig: t3 }, import_react10.default.createElement(Lt, null), import_react10.default.createElement(j2, { customComponents: C5 }), e2)));
};
