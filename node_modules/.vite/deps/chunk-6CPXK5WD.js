...
var i3 = class {
  constructor() {
    ...
    this.logout = () => Bt(this, null, function* () {
      return a.dispatch(L()), yield this._provider.logout();
    });
    this.relogin = () => Bt(this, null, function* () {
      let r2 = yield this._provider.relogin();
      return r2 ? (M(r2), a2(), r2) : (console.error("Unable to re-login. Missing accessToken."), null);
    });
    ...
    this._provider = import_WebviewProvider.WebviewProvider.getInstance({ resetStateCallback: () => a.dispatch(L()) });
  }
  static getInstance() {
    ...
    if (r2 != null) {
      ...
      if (o && H in o) {
        ...
        if (o.status === "cancelled") {
          s7(tn({ sessionId: m3, status: "cancelled" })), L4(), N2({ removeParams: [...Object.keys(d), import_sdk_web_wallet_provider2.WALLET_PROVIDER_CALLBACK_PARAM, H, "address"], search: r2 }), s7(on(c2));
          return;
        }
        if (e4.length > 0) {
...
var F2 = () => {
  ...
  return (p5) => Bt(void 0, null, function* () {
    let u4 = t3 != null ? t3 : yield A4(o), f8 = A3(u4);
...
g();
var Cn = () => {
  let d6 = d3(), { provider: o } = v2(), { nonce: Q2 } = s2(), [R3, A6] = (0, import_react2.useState)(null), [V, X] = (0, import_react2.useState)(), [Y, Z2] = (0, import_react2.useState)([]), _3 = F2(), n4 = k(Mr), $ = k(kr), nn = () => Bt(void 0, null, function* () {
    var e4, r2;
...
l();
function T2(t3) {
  let o = Mr(a.getState()), r2 = Object.keys(t3).length === (o == null ? void 0 : o.transactions.length);
  return t3 && (t3 && r2);
}
...
var jr = b((Oa, Vr) => {
  ...
  function B2(e4) {
    var t3 = -1, n4 = e4 == null ? 0 : e4.length;
    for (this.__data__ = new xs(); ++t3 < n4; )
      this.add(e4[t3]);
  }
...
var Kr = b((Da, $r) => {
  ...
  function qs(e4, t3, n4, c4) {
    for (var v3 = e4.length, p5 = n4 + (c4 ? 1 : -1); c4 ? p5-- : ++p5 < v3; )
      if (t3(e4[p5], p5, e4))
        return p5;
    return -1;
  }
...
var Br = b((Ra, Zr) => {
  ...
  function Ts(e4, t3, n4) {
    for (var c4 = n4 - 1, v3 = e4.length; ++c4 < v3; )
      if (e4[c4] === t3)
        return c4;
    return -1;
  }
...
var nt = b((Ha, tt) => {
  ...
  function Ns(e4, t3, n4) {
    for (var c4 = -1, v3 = e4 == null ? 0 : e4.length; ++c4 < v3; )
      if (n4(t3, e4[c4]))
        return true;
    return false;
  }
    ...
    e:
      for (; ++c4 < p5; ) {
        ...
        if (u4 = n4 || u4 !== 0 ? u4 : 0, R3 && T3 === T3) {
          for (var V = _3.length; V--; )
            if (_3[V] === T3)
              continue e;
          t3 && _3.push(T3), q2.push(u4);
        } else
          v3(_3, T3, n4) || (_3 !== q2 && _3.push(T3), q2.push(u4));
      }
    return q2;
  }
  dt.exports = Ys;
...
c();
var Si = () => {
  let e4 = d3(), t3 = (0, import_react3.useRef)("/"), { provider: n4 } = v2(), c4 = k(m), v3 = z(n4), p5 = (0, import_react3.useRef)(false), R3 = F2(), { isGuarded: q2, address: _3 } = s2(), k3 = k(kr), { transactionsToSign: u4, error: T3, setError: V, hasTransactions: X, onAbort: he, clearTransactionStatusMessage: pe } = Cn();
  sr(he);
  let j2 = (0, Ct.default)(u4 == null ? void 0 : u4.transactions.map((l3) => l3.getSender().toString()).filter((l3) => l3)), G2 = j2 == null ? void 0 : j2[0], { data: de } = A5(!G2 || G2 === _3 ? null : G2), qt = (l3) => {
    ...
    v3 === "walletconnectv2" && (l3 = c2);
    let g4 = l3.includes(c2);
    if (qt(f8), g4) {
      e4(on(c2));
      return;
    }
    ...
    try {
      if (!(yield (W = n4 == null ? void 0 : n4.init) == null ? void 0 : W.call(n4)))
        return;
    } catch (h2) {
    ...
    try {
      ...
      console.error(x4), e4(tn({ sessionId: l3, status: "cancelled" })), $(x4.includes("cancel") ? c2 : x4, l3);
    }
...
S2();
var F4 = () => {
  let a5 = k(R2), w2 = k(I2), r2 = k(f3), o = s3(), [p5, I4] = (0, import_react4.useState)(), S3 = () => Bt(void 0, null, function* () {
    let t3 = (r2 == null ? void 0 : r2.index) != null;
    try {
      if (o instanceof import_sdk_hw_provider.HWProvider && o.isInitialized())
        return t3 && (yield o.setAddressIndex(r2.index)), o;
...
function p3(g4) {
  return Bt(this, arguments, function* ({ address: i4, walletUrl: o, loginType: n4 }) {
    try {
      ...
      if (e4.setAddress(i4).setWalletUrl(o), yield e4.init())
        return e4;
...
//# sourceMappingURL=chunk-6CPXK5WD.js.map
