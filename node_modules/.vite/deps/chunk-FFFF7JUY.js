...
import {
  V as V3
} from "./chunk-TEF7ZBEY.js";
import {
  T as T3
} from "./chunk-7LMRVZJG.js";
import {
  p as p3
} from "./chunk-EWCDP44I.js";
import {
  y as y3
} from "./chunk-USIUPM2U.js";
import {
  q as q2
} from "./chunk-D4GSSSFF.js";
import {
  F,
  M as M4,
  d as d3,
...
import {
  S as S4,
  h
} from "./chunk-KPXQPOHS.js";
import {
  C as C3,
  M as M3
} from "./chunk-5BCZZ7LK.js";
import {
  A as A2
...
var S5 = false;
function Lt() {
  let s2 = k(r), Pe = k(m2), D3 = k(m), { loginMethod: v2, iframeLoginType: Ie } = k(t2), Ce = k(u4), u8 = k(A), N3 = k(C), b6 = k(f4), E3 = k(I2), ye = k(x2), o = k(C2), T4 = o == null ? void 0 : o.nativeAuthConfig, Le = Y2(T4 || false), { data: m5, isLoading: W2, error: _3 } = A4(u8), A7 = (0, import_react8.useRef)(false), t3 = d(), { setLedgerProvider: Se, ledgerData: p7 } = F();
  a4();
  ...
  function Fe() {
    return Bt(this, null, function* () {
      let r3 = yield M3(), e2 = yield p5(r3);
      e2 && n3(e2);
    });
  }
  function Ve() {
  ...
  function He() {
    return Bt(this, null, function* () {
      ...
      let e2 = yield p4({ address: r3, walletUrl: s2.metamaskSnapWalletAddress, loginType: Ie });
      e2 && n3(e2);
    });
  }
  function Ue() {
...
//# sourceMappingURL=chunk-FFFF7JUY.js.map
