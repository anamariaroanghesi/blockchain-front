...
import {
  l as l3,
  t as t2
} from "./chunk-XFB7CCX4.js";
import {
  I as I4
} from "./chunk-OG6APWZO.js";
import {
  k as k4
...
import {
  s as s2
} from "./chunk-X2CYFRKW.js";
import {
  io
} from "./chunk-KA3GW7QJ.js";
import {
  p as p7
} from "./chunk-BRVU47C2.js";
import {
  s as s3
} from "./chunk-VRTYKHRE.js";
import {
  A as A3
...
var S5 = u6(s4, { ssrStyles: () => import("./dappModalStyles-RJDTIPNW.js"), clientStyles: () => (l3(), gt(t2)).default });
...
var D2 = u6(f4, { ssrStyles: () => import("./dappModalStyles-RJDTIPNW.js"), clientStyles: () => (l3(), gt(t2)).default });
...
var q2 = u6(C4, { ssrStyles: () => import("./dappModalStyles-RJDTIPNW.js"), clientStyles: () => (l3(), gt(t2)).default });
...
var po = u6(A5, { ssrStyles: () => import("./dappModalStyles-RJDTIPNW.js"), clientStyles: () => (l3(), gt(t2)).default });
...
var p10 = 10;
var v4 = () => {
  let [d8, r4] = (0, import_react9.useState)(""), [c5, i5] = (0, import_react9.useState)(false), [l6, t4] = (0, import_react9.useState)(0), [a5, g4] = (0, import_react9.useState)([]), [u10, s8] = (0, import_react9.useState)(null), [S8, A6] = (0, import_react9.useState)(false);
  return { accounts: a5, defaultAddressesPerPage: p10, error: d8, isLoading: c5, onGoToNextPage: () => {
    s8(null), t4((e2) => e2 + 1);
  }, onGoToPrevPage: () => {
...
var Xe = ({ callbackRoute: P5, token: oe, addressesPerPage: L4, nativeAuth: x5, onLoginRedirect: k6 }) => {
  let E3 = k2(C), i5 = s(), c5 = d(), z4 = s2(), ne = x5 != null, m7 = Y2(x5), l6 = oe, { accounts: r4, setAccounts: ie, isLoading: b2, setIsLoading: s8, setShowAddressList: h4, showAddressList: y2, startIndex: u10, selectedAddress: a5, onGoToPrevPage: re, onGoToNextPage: se, onGoToSpecificPage: ae, onSelectAddress: de, error: w, setError: p17, defaultAddressesPerPage: ce } = v4(), le = L4 != null ? L4 : ce, [C7, ge] = (0, import_react10.useState)(""), [H2, fe] = (0, import_react10.useState)(false), G2 = ({ address: e2, index: t4, signature: o5 }) => {
    ...
    var o5;
    if (b2) {
      let { errorMessage: I6, defaultErrorMessage: ye } = x(e2), we = (o5 = I6 != null ? I6 : ye) != null ? o5 : f6;
  ...
  (0, import_react10.useEffect)(() => {
    he();
  }, [u10, y2, i5]), (0, import_react10.useEffect)(() => {
...
v();
T();
var P3 = ({ hideButtonWhenModalOpens: f8, onContentHide: o5, onContentShow: s8, onModalCloses: e2, onModalOpens: t4, token: c5, wrapContentInsideModal: r4 }) => {
  let m7 = I3(), [n3, d8] = (0, import_react11.useState)(false), { handleShowModal: g4, handleHideModal: w, showModal: M } = h(), y2 = k4(c5), I6 = !f8 || !n3, i5 = () => {
...
function m4({ transactions: n3 }) {
  let [a5, o5] = (0, import_react13.useState)({}), [c5, l6] = (0, import_react13.useState)([]);
  function p17(e2, t4) {
...
var Nn = ({ isLedger: b2 = false, transactionsToSign: h4, egldLabel: Z2, address: g4, activeGuardianAddress: I6, hasGuardianScreen: $, onCancel: a5, onSignTransaction: C7, onTransactionsSignError: nn, onTransactionsSignSuccess: G2, onGetScamAddressData: M }) => {
  var L4, U2, W3, _2;
  let A6 = Boolean(I6), [c5, i5] = (0, import_react14.useState)(0), [l6, E3] = (0, import_react14.useState)(), [e2, en] = (0, import_react14.useState)(null), [tn2, F2] = (0, import_react14.useState)(false), { getTxInfoByDataField: sn, allTransactions: s8 } = m4({ transactions: I6 ? h4 == null ? void 0 : h4.map((n3) => {
  ...
  }) : h4 }), w = c5 === s8.length - 1, B = s8[c5], f8 = (L4 = e2 == null ? void 0 : e2.transaction) == null ? void 0 : L4.getSender().toString(), { data: O5 } = A3(!f8 || f8 === g4 ? null : f8), rn = () => Bt(void 0, null, function* () {
    var j3;
    if (B == null)
      return;
    ...
    if (f8 && f8 !== g4 && !n2(O5, g4))
      return console.error(S2), a5 == null ? void 0 : a5();
...
function S7({ tokenId: n3 }) {
  var s8, e2, o5, a5;
  let { network: r4 } = p7(), { isNft: y2 } = g2(n3), t4 = n3, b2 = y2 ? a : k, { data: i5, error: k6, isLoading: N6 } = useSWR(Boolean(t4) ? `${r4.apiAddress}/${b2}/${t4}` : null, P4);
  if (!t4)
...
var ao = ({ callbackRoute: n3, token: E3, nativeAuth: c5, onLoginRedirect: P5 }) => {
  let [l6, U2] = (0, import_react16.useState)(""), [A6, r4] = (0, import_react16.useState)(false), C7 = c5 != null, t4 = Y2(c5), o5 = E3, D4 = d(), p17 = s2();
  function F2() {
    return Bt(this, null, function* () {
      if (p17)
        throw new Error(I);
...
var Mo = ({ callbackRoute: e2, token: _2, nativeAuth: m7, onLoginRedirect: B, hasConsentPopup: H2, walletAddress: t4 }) => {
  let [f8, R2] = (0, import_react18.useState)(""), [$, r4] = (0, import_react18.useState)(false), l6 = m7 != null, s8 = Y2(m7), o5 = _2, z4 = k2(r), a5 = d(), L4 = s2();
  function j3() {
    return Bt(this, null, function* () {
      if (L4)
        throw new Error(I);
      ...
      try {
        ...
        let n3 = yield A4({ loginToken: o5, extraInfoData: { multisig: V2, impersonate: X }, address: w, signature: u10, loginService: s8 });
        if (!n3)
          return;
        a5(f2({ address: n3.address, loginMethod: "crossWindow" })), a5(Y(n3.address)), a5(O(xt(yt({}, n3), { nonce: A2(n3) }))), L({ callbackRoute: e2, onLoginRedirect: B, options: { signature: u10, address: n3.address } });
      } catch (i5) {
...
//# sourceMappingURL=chunk-MRPY32VR.js.map
