...
import {
  ...
  n as n2,
  u as u5
} from "./chunk-YR6CKEVU.js";
import {
  A as A4
} from "./chunk-DKK4TDYP.js";
import {
  N as N5,
  p2 as p6
...
import {
  io
} from "./chunk-CQMMNMNS.js";
import {
  d as d6
} from "./chunk-5OV7EF6E.js";
import {
  I as I4
} from "./chunk-BNCAB7NX.js";
import {
  A as A2
} from "./chunk-PECJKTKY.js";
import {
  Y as Y2
} from "./chunk-577RMEBJ.js";
import {
  s as s2
} from "./chunk-YM3AGUDG.js";
import {
  A2 as A3,
  a as a3
} from "./chunk-7SIS6GIO.js";
import {
  C2 as C3,
  S as S4,
  p as p5,
  u as u4,
  useSWR
} from "./chunk-H4UV5ZXO.js";
import {
  v as v3
} from "./chunk-66WEGHAK.js";
import {
  N as N4,
  V,
  import_operation,
  ...
  s,
  z as z2
} from "./chunk-DAR34Q27.js";
import {
  p as p4
} from "./chunk-VXC2BGTX.js";
import {
  I as I3
} from "./chunk-HKY2VV4S.js";
import {
  C,
  F,
  N2 as N3,
...
var ao = ({ callbackRoute: n3, token: E3, nativeAuth: c5, onLoginRedirect: P5 }) => {
  let [l6, U2] = (0, import_react.useState)(""), [A6, r4] = (0, import_react.useState)(false), C7 = c5 != null, t4 = Y2(c5), o5 = E3, D4 = d(), p17 = s2();
  function F2() {
...
v();
var p8 = (e2, n3) => {
  let [o5, r4] = (0, import_react2.useState)(e2);
...
function h() {
  let r4 = k2(p3), a5 = d();
  return { notification: r4, clearNotification: () => a5(N2()) };
}
...
function m3({ transactions: n3 }) {
  let [a5, o5] = (0, import_react4.useState)({}), [c5, l6] = (0, import_react4.useState)([]);
  function p17(e2, t4) {
...
var Nn = ({ isLedger: b2 = false, transactionsToSign: h4, egldLabel: Z2, address: g4, activeGuardianAddress: I6, hasGuardianScreen: $, onCancel: a5, onSignTransaction: C7, onTransactionsSignError: nn, onTransactionsSignSuccess: G2, onGetScamAddressData: M }) => {
  var L4, U2, W3, _2;
  let A6 = Boolean(I6), [c5, i5] = (0, import_react5.useState)(0), [l6, E3] = (0, import_react5.useState)(), [e2, en] = (0, import_react5.useState)(null), [tn2, F2] = (0, import_react5.useState)(false), { getTxInfoByDataField: sn, allTransactions: s8 } = m3({ transactions: I6 ? h4 == null ? void 0 : h4.map((n3) => {
    ...
    if (f8 && f8 !== g4 && !n2(O5, g4))
      return console.error(S), a5 == null ? void 0 : a5();
    let o5 = g4 !== r4, R2 = r4 in D2;
    if (r4 && o5 && !R2 && M != null) {
      let m7 = yield M(r4);
      D2 = yt(yt({}, D2), m7 != null && m7.scamInfo ? { [r4]: m7.scamInfo } : {});
    }
    let S8 = Boolean(p17 && d2({ tokenId: p17, erdLabel: Z2 }));
    en({ transaction: n3, receiverScamInfo: ((j3 = D2[r4]) == null ? void 0 : j3.info) || null, transactionTokenInfo: u10, isTokenTransaction: S8, dataField: v5, transactionIndex: T4 });
  });
...
v();
var r2 = {};
var s4 = { setItem: (e2, a5) => Bt(void 0, null, function* () {
  try {
...
function P3(t4) {
  return Bt(this, null, function* () {
    let { apiAddress: c5, apiTimeout: p17 } = r(a2.getState()), f8 = { baseURL: c5, timeout: Number(p17) }, o5 = yield s4.getItem(t4);
    if (o5)
      return o5;
    let a5 = yield u4.get(t4, f8);
    return yield s4.setItem(t4, a5.data), a5.data;
  });
}
...
function S6({ tokenId: n3 }) {
  ...
  if (!t4)
    return { tokenDecimals: Number(r4.decimals), tokenLabel: "", tokenAvatar: "" };
...
var Mo = ({ callbackRoute: e2, token: _2, nativeAuth: m7, onLoginRedirect: B, hasConsentPopup: H2, walletAddress: t4 }) => {
  let [f8, R2] = (0, import_react8.useState)(""), [$, r4] = (0, import_react8.useState)(false), l6 = m7 != null, s8 = Y2(m7), o5 = _2, z4 = k2(r), a5 = d(), L4 = s2();
  function j3() {
    return Bt(this, null, function* () {
      if (L4)
        throw new Error(I);
...
v();
var h2 = (e2) => {
  let [n3, a5] = (0, import_react9.useState)(false), t4 = () => {
    a5(true);
  }, l6 = () => {
    a5(false);
  };
...
var P4 = ({ hideButtonWhenModalOpens: f8, onContentHide: o5, onContentShow: s8, onModalCloses: e2, onModalOpens: t4, token: c5, wrapContentInsideModal: r4 }) => {
  let m7 = I3(), [n3, d8] = (0, import_react10.useState)(false), { handleShowModal: g4, handleHideModal: w, showModal: M } = h2(), y2 = k4(c5), I6 = !f8 || !n3, i5 = () => {
...
v();
var s5 = ({ className: t4, children: a5, styles: o5 }) => import_react11.default.createElement("div", { className: (0, import_classnames.default)(o5 == null ? void 0 : o5.dappModalBody, t4) }, a5);
var S7 = u6(s5, { ssrStyles: () => import("./dappModalStyles-RP6YDXXL.js"), clientStyles: () => (l3(), gt(t2)).default });
...
v();
var f6 = ({ visible: i5, customFooter: e2, className: a5, footerText: l6, styles: o5 }) => i5 ? import_react12.default.createElement("div", { className: (0, import_classnames2.default)(o5 == null ? void 0 : o5.dappModalFooter, a5) }, e2 != null ? e2 : import_react12.default.createElement("div", null, l6)) : null;
var D3 = u6(f6, { ssrStyles: () => import("./dappModalStyles-RP6YDXXL.js"), clientStyles: () => (l3(), gt(t2)).default });
...
v();
var C5 = ({ visible: m7, headerText: t4, customHeader: a5, className: e2, closeButtonClassName: f8, headerTextClassName: T4, onHide: u10, globalStyles: o5, styles: r4 }) => m7 ? a5 ? import_react13.default.createElement("div", { className: (0, import_classnames3.default)(r4 == null ? void 0 : r4.dappModalHeader, e2) }, a5) : import_react13.default.createElement("div", { className: (0, import_classnames3.default)(r4 == null ? void 0 : r4.dappModalHeader, e2) }, import_react13.default.createElement("div", { className: (0, import_classnames3.default)(r4 == null ? void 0 : r4.dappModalHeaderText, T4) }, t4), import_react13.default.createElement("button", { onClick: u10, className: (0, import_classnames3.default)(r4 == null ? void 0 : r4.dappModalCloseButton, o5 == null ? void 0 : o5.btn, o5 == null ? void 0 : o5.btnLight, f8) }, import_react13.default.createElement(FontAwesomeIcon, { size: "lg", icon: faTimes }))) : null;
var q2 = u6(C5, { ssrStyles: () => import("./dappModalStyles-RP6YDXXL.js"), clientStyles: () => (l3(), gt(t2)).default });
...
var A5 = ({ "data-testid": i5 = "dappModal", children: n3, className: f8 = "dapp-modal-dialog-wrapper", closeOnEscape: c5, config: u10 = z3, id: C7 = "dapp-modal", onHide: e2, parentElement: d8, visible: h4, styles: a5 }) => {
  let [M, N6] = (0, import_react15.useState)(false);
  ...
  return import_react14.default.createElement(import_react14.default.Fragment, null, M && (0, import_react_dom.createPortal)(import_react14.default.createElement("div", { id: C7, role: "dialog", "aria-modal": "true", className: (0, import_classnames4.default)(y2, a5 == null ? void 0 : a5.dappModal, f8), "data-testid": i5, onKeyDown: I6 }, import_react14.default.createElement("div", { className: (0, import_classnames4.default)(a5 == null ? void 0 : a5.dappModalContent, v5) }, import_react14.default.createElement(q2, { visible: g4, headerText: T4, customHeader: E3, className: b2, headerTextClassName: w, closeButtonClassName: B, onHide: e2 }), import_react14.default.createElement(S7, { className: F2 }, n3), import_react14.default.createElement(D3, { visible: D4, customFooter: H2, footerText: x5, className: S8 }))), d8 != null ? d8 : document == null ? void 0 : document.body));
};
var po = u6(A5, { ssrStyles: () => import("./dappModalStyles-RP6YDXXL.js"), clientStyles: () => (l3(), gt(t2)).default });
...
var Xe = ({ callbackRoute: P5, token: oe, addressesPerPage: L4, nativeAuth: x5, onLoginRedirect: k6 }) => {
  let E3 = k2(C), i5 = s(), c5 = d(), z4 = s2(), ne = x5 != null, m7 = Y2(x5), l6 = oe, { accounts: r4, setAccounts: ie, isLoading: b2, setIsLoading: s8, setShowAddressList: h4, showAddressList: y2, startIndex: u10, selectedAddress: a5, onGoToPrevPage: re, onGoToNextPage: se, onGoToSpecificPage: ae, onSelectAddress: de, error: w, setError: p17, defaultAddressesPerPage: ce } = v4(), le = L4 != null ? L4 : ce, [C7, ge] = (0, import_react18.useState)(""), [H2, fe] = (0, import_react18.useState)(false), G2 = ({ address: e2, index: t4, signature: o5 }) => {
    c5(v2({ index: t4, loginType: "ledger" })), o5 && m7.setTokenLoginInfo({ signature: o5, address: e2 }), c5(f2({ address: e2, loginMethod: "ledger" })), L({ callbackRoute: P5, onLoginRedirect: k6, options: { address: e2, signature: o5 } });
  }, n3 = (e2, t4 = "") => {
    var o5;
    if (b2) {
    ...
    try {
      if (i5 instanceof import_sdk_hw_provider.HWProvider && i5.isInitialized())
        return i5.isConnected();
    } catch (e2) {
      n3(e2);
    }
    return false;
    ...
    try {
      if (s8(true), a5 == null)
        return false;
      c5(E3 ? z(a5) : q(xt(yt({}, a5), { version: C7, hasContractDataEnabled: H2 }))), s8(false), yield pe();
    } catch (e2) {
      n3(e2);
    }
    ...
    try {
      s8(true);
      let t4 = yield i5.getAccounts(u10, le), o5 = yield N4(i5);
...
N();
function h3() {
  let c5 = (n3) => s3(n3).then((m7) => m7.data), { data: r4, error: i5 } = useSWR(S2, c5);
...
var gn2 = ({ callbackRoute: y2, token: b2, nativeAuth: M, onLoginRedirect: we, logoutRoute: x5, customRequestMethods: Ce = [] }) => {
  var $;
  let G2 = d(), L4 = N5(M), p17 = Y2(L4 ? M : false), n3 = b2, [_2, l6] = (0, import_react20.useState)(""), [h4, ye] = (0, import_react20.useState)(""), [F2, f8] = (0, import_react20.useState)(true), [Le, U2] = (0, import_react20.useState)([]), [T4, A6] = (0, import_react20.useState)(null), { provider: R2 } = v3(), E3 = k2(k3), I6 = k2(C2), P5 = k2(g3), he = k2(u3), Te = k2(R), Ee = k2(x3), e2 = (0, import_react20.useRef)(R2), m7 = (0, import_react20.useRef)(false), v5 = (0, import_react20.useRef)(false), B = ($ = x5 != null ? x5 : Te) != null ? $ : "/", S8 = [import_operation.OptionalOperation.CANCEL_ACTION, ...Ce];
  ...
  let Ie = F2 ? "" : `${he}?wallet-connect=${encodeURIComponent(h4)}`, k6 = Boolean(_2), D4 = s2(), Pe = () => {
    ...
    var o5, r4, i5, c5, a5;
    if (z2(e2.current) === "walletconnectv2")
      try {
    ...
    try {
      if ((e2.current ? z2(e2.current) : false) !== "walletconnectv2") {
        yield w();
        return;
      }
    ...
    return Bt(this, null, function* () {
      ...
      if (!!e2.current) {
        ...
        try {
          ...
          if (n3 && p17.setLoginToken(n3), (e2.current ? z2(e2.current) : false) !== "walletconnectv2") {
            f8(true), yield w();
            return;
          }
          try {
...
//# sourceMappingURL=chunk-XPN3BT4S.js.map
