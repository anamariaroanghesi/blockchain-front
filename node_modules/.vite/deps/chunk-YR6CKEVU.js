    ...
    if (r2 != null) {
      ...
      if (o && H in o) {
        ...
        if (o.status === "cancelled") {
          s7(tn({ sessionId: m3, status: "cancelled" })), L4(), N2({ removeParams: [...Object.keys(d), import_sdk_web_wallet_provider2.WALLET_PROVIDER_CALLBACK_PARAM, H, "address"], search: r2 }), s7(on(c));
          return;
        }
        if (e4.length > 0) {
...
//# sourceMappingURL=chunk-YR6CKEVU.js.map
