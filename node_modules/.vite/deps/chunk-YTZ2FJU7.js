...
var yt = (e, r) => {
  for (var t in r || (r = {}))
    z.call(r, t) && er(e, t, r[t]);
  if (D)
    for (var t of D(r))
      ir.call(r, t) && er(e, t, r[t]);
  return e;
};
...
var Et = (e, r) => {
  var t = {};
  for (var i in e)
    z.call(e, i) && r.indexOf(i) < 0 && (t[i] = e[i]);
  if (e != null && D)
    for (var i of D(e))
      r.indexOf(i) < 0 && ir.call(e, i) && (t[i] = e[i]);
  return t;
};
...
var Ft = (e, r) => {
  for (var t in r)
    k(e, t, { get: r[t], enumerable: true });
};
var nr = (e, r, t, i) => {
  if (r && typeof r == "object" || typeof r == "function")
    for (let n of Mr(r))
      !z.call(e, n) && n !== t && k(e, n, { get: () => r[n], enumerable: !(i = Rr(r, n)) || i.enumerable });
  return e;
};
...
var hr = b((N) => {
  ...
  for (d = 0, or = J.length; d < or; ++d)
    F[d] = J[d], m[J.charCodeAt(d)] = d;
  var d, or;
  m["-".charCodeAt(0)] = 62;
  m["_".charCodeAt(0)] = 63;
  function ar(e) {
  ...
  function Yr(e) {
    ...
    for (h = 0; h < f; h += 4)
      r = m[e.charCodeAt(h)] << 18 | m[e.charCodeAt(h + 1)] << 12 | m[e.charCodeAt(h + 2)] << 6 | m[e.charCodeAt(h + 3)], u[o++] = r >> 16 & 255, u[o++] = r >> 8 & 255, u[o++] = r & 255;
  ...
  function Hr(e, r, t) {
    for (var i, n = [], u = r; u < t; u += 3)
      i = (e[u] << 16 & 16711680) + (e[u + 1] << 8 & 65280) + (e[u + 2] & 255), n.push(qr(i));
    return n.join("");
  }
  function Xr(e) {
    for (var r, t = e.length, i = t % 3, n = [], u = 16383, o = 0, f = t - i; o < f; o += u)
      n.push(Hr(e, o, o + u > f ? f : o + u));
...
var Ar = b((_) => {
  ...
  function sr(e, r, t) {
    ...
    if (g(e, ArrayBuffer) || e && g(e.buffer, ArrayBuffer) || typeof SharedArrayBuffer != "undefined" && (g(e, SharedArrayBuffer) || e && g(e.buffer, SharedArrayBuffer)))
      return O(e, r, t);
    if (typeof e == "number")
  ...
  function K(e) {
    for (var r = e.length < 0 ? 0 : P(e.length) | 0, t = U(r), i = 0; i < r; i += 1)
      t[i] = e[i] & 255;
    return t;
  }
  function Qr(e) {
  ...
  function Vr(e) {
    ...
    if (e.length !== void 0)
      return typeof e.length != "number" || j(e.length) ? U(0) : K(e);
  ...
  a.compare = function(r, t) {
    if (g(r, Uint8Array) && (r = a.from(r, r.offset, r.byteLength)), g(t, Uint8Array) && (t = a.from(t, t.offset, t.byteLength)), !a.isBuffer(r) || !a.isBuffer(t))
  ...
  a.prototype.compare = function(r, t, i, n, u) {
    ...
    if (t >>>= 0, i >>>= 0, n >>>= 0, u >>>= 0, this === r)
      return 0;
    for (var o = u - n, f = i - t, h = Math.min(o, f), p = this.slice(n, u), l = r.slice(t, i), c = 0; c < h; ++c)
      if (p[c] !== l[c]) {
        o = p[c], f = l[c];
        break;
      }
  ...
  function xr(e, r, t, i, n) {
    ...
    if (typeof r == "string" && (r = a.from(r, i)), a.isBuffer(r))
      return r.length === 0 ? -1 : cr(e, r, t, i, n);
    if (typeof r == "number")
      return r = r & 255, typeof Uint8Array.prototype.indexOf == "function" ? n ? Uint8Array.prototype.indexOf.call(e, r, t) : Uint8Array.prototype.lastIndexOf.call(e, r, t) : cr(e, [r], t, i, n);
    throw new TypeError("val must be string, number or Buffer");
  }
  function cr(e, r, t, i, n) {
    ...
    if (n) {
      var l = -1;
      for (p = t; p < o; p++)
        if (h(e, p) === h(r, l === -1 ? 0 : p - l)) {
          if (l === -1 && (l = p), p - l + 1 === f)
            return l * u;
        } else
          l !== -1 && (p -= p - l), l = -1;
    } else
      for (t + f > o && (t = o - f), p = t; p >= 0; p--) {
        for (var c = true, E = 0; E < f; E++)
          if (h(e, p + E) !== h(r, E)) {
            c = false;
            break;
          }
  ...
  function et(e) {
    ...
    for (var t = "", i = 0; i < r; )
      t += String.fromCharCode.apply(String, e.slice(i, i += lr));
    return t;
  }
  function it(e, r, t) {
    var i = "";
  ...
  a.prototype.writeIntLE = function(r, t, i, n) {
    ...
    for (this[t] = r & 255; ++o < i && (f *= 256); )
      r < 0 && h === 0 && this[t + o - 1] !== 0 && (h = 1), this[t + o] = (r / f >> 0) - h & 255;
    return t + i;
  };
...
var dr = b((It, Ir) => {
  ...
  function vr(e) {
    ...
    if ((B === rr || !B) && setTimeout)
      return B = setTimeout, setTimeout(e, 0);
    try {
      return B(e, 0);
    } catch (r) {
      try {
...
@multiversx/sdk-dapp/__chunks__/chunk-HBP5N4FR.js:
  ...
  (*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> *)
*/
//# sourceMappingURL=chunk-YTZ2FJU7.js.map
